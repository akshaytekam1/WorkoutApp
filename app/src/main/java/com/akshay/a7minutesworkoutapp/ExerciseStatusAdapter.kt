...
import com.akshay.a7minutesworkoutapp.databinding.ItemExerciseStatusBinding
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when{
            ...
            model.getIsCompleted()-> {
                ...
                holder.tvItem.background = ContextCompat.getDrawable(holder.itemView.context, R.drawable.item_circular_color_gray_backgroud)
                holder.tvItem.setTextColor(Color.parseColor("#212121"))
            }
        }
    }
